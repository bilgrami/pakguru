# Generated by Django 2.2.2 on 2019-07-01 00:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True, verbose_name='Description')),
                ('facebook_link', models.CharField(blank=True, max_length=300, null=True, verbose_name='Facebook')),
                ('twitter_link', models.CharField(blank=True, max_length=300, null=True, verbose_name='Twitter')),
                ('instagram_link', models.CharField(blank=True, max_length=300, null=True, verbose_name='Instagram')),
                ('is_active', models.BooleanField(default=True, verbose_name='Is Active')),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
